...
export const MOCK_NOTIFICATIONS: Notification[] = [
  ...
  { id: 'n-3', type: 'message', title: 'New message from Dr. Ayesha', body: 'Please make sure to complete the homework before our next session.', time: '5 hours ago', read: false, link: '/messages' },
  { id: 'n-4', type: 'system', title: 'AI Readiness score updated', body: 'Your weekly readiness score has been updated. You\'re now at 68% — up 5% from last week!', time: 'Yesterday', read: true, link: '/readiness' },
  ...
  { id: 'n-6', type: 'payment', title: 'Subscription renewed', body: 'Your Student AI Plan has been renewed for PKR 999. Next billing date: Jul 22, 2025.', time: '3 days ago', read: true, link: '/subscription' },
